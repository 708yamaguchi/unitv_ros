...
// Select BLUETOOTH, WIFI or USB(deprecated)
#define BLUETOOTH
...
ros::NodeHandle_<BluetoothHardware, 25, 25, 8192, 8192> nh;
#endif
#ifdef WIFI
#include "include/wifi.h"
ros::NodeHandle_<WiFiHardware, 25, 25, 8192, 8192> nh;
#endif
